...
# Agata de Oliveira - DRE 117232944
# Douglas de Morais Lima - DRE 117227656
...
# E tem tambem a discrição de cada transição apartir de todos os estados
Linguagem_a = {
      'inicial' : 'Q0',
      'final' : 'Q2',
      'Q0' : {'0' : 'Q1', '1' : 'Q0'},
...
# Decidimos colocar 3 linguagens diferentes, para incluir todas as partes do trabalho dos dois membros.

# Esta função recebe uma linguagem e diz se ela é valida ou não
def verifica_linguagem(linguagem):
   # Primeiro testa se ela é A, B ou C, e se não
   if    linguagem == "A" : linguagem = Linguagem_a
   elif  linguagem == "B" : linguagem = Linguagem_b
   elif  linguagem == "C" : linguagem = Linguagem_c
   else: 
...
linguagem = (input("\nEntre com uma linguagem [A/B/C]: ")).upper()
